...
<div class="row">
    ...
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="pfblock-header wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
            <a href="#portfolio"><div style="font-size: 13pt;font-weight: 500" class="back">Back in works</div></a>
            ...
            <p style="font-weight: 600"><?=$model['work_tech']?>Back-end : Java/Grails</p>
